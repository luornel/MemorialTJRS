            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        ...
                        <div class="endereço">
                            Praça Marechal Deodoro, 55 | Térreo | Palácio da Justiça - TJRS<br>
                            Centro Histórico | CEP: 90010-906 | Porto Alegre, RS Brasil
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="social">
                        <a class="redes-sociais"><strong>Redes Sociais:</strong></a>
                            <div class="icones-sociais">
                                <a href="https://www.facebook.com/memorialtjrs/" target="_blank">
                                    <img src="<?php echo get_template_directory_uri(); ?>/Imagens/Icones/Facebook Icon.png" width="22" height="22" alt="instagram logo"></a>
                                <a href="http://www.facebook.com/memorialtjrs" target="_blank">
                                    <img src="<?php echo get_template_directory_uri(); ?>/Imagens/Icones/Instagram Icon.png" width="22" height="22" alt="facebook logo"></a>
                                <a href="https://www.youtube.com/@tjrsnoticias" target="_blank">
                                    <img src="<?php echo get_template_directory_uri(); ?>/Imagens/Icones/Youtube Icon.png" width="24" height="24" alt="youtube logo"></a>
                                <a href="https://soundcloud.com/user-891322221/podcast-gestando-memorias-ep-0-piloto?si=781aad14318a4d97afc0d004f2b5cc80&utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing" target="_blank">
                                    <img src="<?php echo get_template_directory_uri(); ?>/Imagens/Icones/Soundcloud Icon.png" width="24" height="24" alt="soundcloud logo"></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                                <a class="LogoTJ150">
                                    <img src="<?php echo get_template_directory_uri(); ?>/Imagens/Logos/TJ 150 anos.png" width="50" height="50">
                                </div>
                            </div>
                        </div>
